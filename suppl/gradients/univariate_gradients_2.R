...
install.packages(c('devtools', 'mobr', 'leaflet', 'mapview', 'tidyr',
                   'vegan', 'dplyr', 'ggplot2', 'egg', 'rdryad'))
...
ggsave("grad_vs_N.pdf", plot = N1, width = 15, height = 12, 
       units = "cm")
...
g = ggarrange(p1, p2)
ggsave("ENS.pdf", plot = g, width = 20, height = 15, units = "cm")
