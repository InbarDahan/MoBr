...
setwd(wd_models)
one_model_a <- readRDS("one_model_a_50.rds")
one_model_r <- readRDS("one_model_r_50.rds")
best_models_aic_a <- readRDS("best_models_aic_a_50.rds")
best_models_aic_r <- readRDS("best_models_aic_r_50.rds")
subsets_taxons <- readRDS("subsets_taxons_50.rds")
subsets_taxons_clean <- readRDS("subsets_taxons_clean_50.rds")
