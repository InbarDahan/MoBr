...
transformed_data <- combined_data_up2_50 %>% pivot_wider(names_from = diversity_measure, values_from = value)
...
setwd(wd_models)
saveRDS(subsets_taxons, file = "subsets_taxons_50.rds")
# _____________________________________________________________
...
# save the models output:
setwd(wd_models)
saveRDS(subsets_taxons_clean, file = "subsets_taxons_clean_50.rds")
